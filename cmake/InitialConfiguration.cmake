...
set(PLATFORM_SPATIAL 0 CACHE INTERNAL "")
...
set(OPTION_DISTRIBUTION "local" CACHE STRING "Distribution")
set(SUPPORTED_DISTRIBUTIONS "")
list(APPEND SUPPORTED_DISTRIBUTIONS "local")
list(APPEND SUPPORTED_DISTRIBUTIONS "steam")
list(APPEND SUPPORTED_DISTRIBUTIONS "googleplay")
list(APPEND SUPPORTED_DISTRIBUTIONS "appstore")
list(APPEND SUPPORTED_DISTRIBUTIONS "docker")
set_property(CACHE OPTION_DISTRIBUTION PROPERTY STRINGS ${SUPPORTED_DISTRIBUTIONS})
...
elseif(${CMAKE_SYSTEM_NAME} MATCHES "Darwin" OR ${CMAKE_SYSTEM_NAME} MATCHES "iOS" OR ${CMAKE_SYSTEM_NAME} MATCHES "visionOS")
	...
	elseif(${CMAKE_SYSTEM_NAME} MATCHES "visionOS")
		...
		set(PLATFORM_SPATIAL 1 CACHE INTERNAL "")
...
set(TARGET_ENVIRONMENT "internal_development" CACHE STRING "Target Environment")
set(TARGET_ENVIRONMENTS internal_development local_backend_development internal_staging staging live)

set(LOCAL_BACKEND_HOST "http://localhost:8080" CACHE STRING "Local backend address")
set(LOCAL_BACKEND_PHP_HOST "http://localhost:8282" CACHE STRING "Local backend address")
set(LOCAL_BACKEND_DOMAIN_KEY "6gllcfg9" CACHE STRING "Local backend domain key")
set(LOCAL_BACKEND_GAME_API_KEY "0125cf40b680d9d9a24f4c13c7370abca020b6fe" CACHE STRING "Local backend game api")
set(LOCAL_BACKEND_SERVER_API_KEY "9d4eada21602e3cbce0b79a1997bfecef6e5f42b" CACHE STRING "Local backend server api")
set_property(CACHE TARGET_ENVIRONMENT PROPERTY STRINGS local_backend_development internal_development internal_staging staging live)

option(OPTION_PACKAGE "Package assets" ON)
option(OPTION_INSTALL "Support CMake install" OFF)
if(OPTION_INSTALL AND NOT OPTION_PACKAGE)
	message(FATAL_ERROR "Install requires packaging to be enabled!")
endif()
...
option(OPTION_CODE_HOT_RELOAD "Enable hot reload for code" OFF)
if (NOT COMPILER_MSVC)
	set (OPTION_CODE_HOT_RELOAD OFF CACHE INTERNAL "")
endif()
if (OPTION_CODE_HOT_RELOAD AND USE_CCACHE)
	message(WARNING "ccache is not compatible with hot reload, disabling ccache.")
