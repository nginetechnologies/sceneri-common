...
function(SetupAppleTarget target)
	...
	if(target_type STREQUAL "EXECUTABLE")
		set_target_properties(${target} PROPERTIES
			...
			XCODE_ATTRIBUTE_DEVELOPMENT_TEAM "${OPTION_XCODE_DEVELOPMENT_TEAM}"
			...
			XCODE_SCHEME_LLDB_INIT_FILE "${CMAKE_BINARY_DIR}/.lldbinit"
		)
    ...
    set_target_properties(${target} PROPERTIES
		...
		XCODE_ATTRIBUTE_ONLY_ACTIVE_ARCH[variant=Profile] "YES"
    )
